...
export class MakeCommand {
    ...
    async controller(
        ...
        .ensureDir('.')
        .cd('.')
        .render('controller.empty.ts', fileName, names)
    
        if (root !== '') {
          fs.ensureFile('index.ts')
    ...
    async entity(
        ...
        fs
        .cd(root)
        .render('entity.empty.ts', `${names.kebabName}.entity.ts`, names);
    ...
    async hook(
        ...
        fs
          .cd(root)
          .render('hook.empty.ts', `${names.kebabName}.hook.ts`, names)
